...
Two companion recordings to watch before starting your capstone: a broad overview of the cutting-edge ML tooling landscape, and a practical walkthrough of a complete design workflow.

```{=html}
<div class="workshop-companion">
  <div class="wc-title">🎥 Part 1 — Cutting-edge ML tools for protein design pipelines</div>
  <div class="wc-video">
...
<div class="workshop-companion">
  <div class="wc-title">🎥 Part 2 — AI-driven protein design workflow: a practical example</div>
  <div class="wc-video">
...
<div class="visual-grid">
  <div class="lesson-visual">
    ...
    <p class="lesson-visual-caption">Treat the capstone as an iterative evidence trail. Each pass should record the target, settings, outputs, validation result, and reason for keeping or discarding a design.</p>
  </div>
  <div class="lesson-visual">
    ...
    <p class="lesson-visual-caption">Start from a real binding face. A small set of high-value hotspot residues gives RFdiffusion or BindCraft a much clearer target than an unrestricted protein surface.</p>
  </div>
</div>
```
...
|--------|-----|-------|
| [TrkA receptor](targets/trka.qmd) | [1WWC](https://www.rcsb.org/structure/1WWC) | Nerve Growth Factor Receptor |
| [TEM-1 Beta-Lactamase](targets/tem-1.qmd) | [1FQG](https://www.rcsb.org/structure/1FQG) | Antibiotic Resistance Enzyme |
| [GM2 Activator Protein](targets/gm3.qmd) | [1G13](https://www.rcsb.org/structure/1G13) | Lipid Transport Protein |
