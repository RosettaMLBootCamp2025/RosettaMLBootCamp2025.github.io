...
<div class="molstar-container">
    <!-- 
      PDB 4ZQK: Crystal structure of human PD-1 (Chain A) complexed with PD-L1 (Chain B)
      hide-controls="true" keeps the UI simple for this overview 
    -->
    <pdbe-molstar 
      id="pd-l1-viewer" 
      molecule-id="4zqk" 
...
1.  **Download PDB `4ZQK`**.
2.  **Clean the structure:** You only need Chain A (PD-L1). You can remove Chain B (PD-1) and any water molecules.
