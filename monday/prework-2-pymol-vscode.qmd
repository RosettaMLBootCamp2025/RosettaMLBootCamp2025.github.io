...
1.  `1ubq_session.pse` - Your saved PyMOL session. Open it to make sure it loads your view.
2.  `1ubq_visualization.png` - Your rendered image of Ubiquitin.
3.  `verification_result.txt` - Output from the verification script showing success.

**Self-Check:**
- Can you navigate comfortably in PyMOL (rotate, zoom, clip)?
- Can you run a Python script directly inside VS Code?
- Did you successfully install the Python and Jupyter extensions?
...
If you have questions, please open an issue on the [GitHub repository](https://github.com/RosettaMLBootCamp2025/RosettaMLBootCamp2025.github.io/issues) (GitHub account required) instead of emailing directly.
