...
<input type="checkbox" class="module-checkbox" data-module-id="bindcraft-prep"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="bindcraft-install"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="bindcraft-test"> Mark as complete
...
**Navigation:** [← PLACER](9-placer.qmd) | [Monday Overview](index.qmd) | [Next: ESM3 (Optional) →](11-esm3.qmd)
