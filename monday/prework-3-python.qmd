...
<a href="files/python-refresher.zip" class="btn btn-primary" download>
  <i class="bi bi-download"></i> Download Assignment Files (ZIP)
</a>
...
Small molecular-weight differences from rounding are acceptable. The important checks are that all four protein records appear, lengths use amino acids (`aa`), and every record includes molecular weight, hydrophobic count, positive and negative counts, and net charge.
