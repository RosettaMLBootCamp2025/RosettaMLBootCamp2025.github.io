...
**Note**: This tool is marked as **OPTIONAL** because [RFdiffusion2](3-rfdiffusion2.qmd) is the newer, more capable version. Install this only if you need the earlier methodology or specific features.
...
**Related Tools**: For the newer version, see [RFdiffusion2](3-rfdiffusion2.qmd). For sequence design, see [LigandMPNN](2-ligandmpnn.qmd).
...
<input type="checkbox" class="module-checkbox" data-module-id="rfdiffusion-aa-prep"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="rfdiffusion-aa-install"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="rfdiffusion-aa-test"> Mark as complete
...
**Recommendation**: Use [RFdiffusion2](3-rfdiffusion2.qmd) for new projects unless you have specific reasons to use this version.
...
**Navigation:** [← ESM3 (Optional)](11-esm3.qmd) | [Monday Overview](index.qmd)
