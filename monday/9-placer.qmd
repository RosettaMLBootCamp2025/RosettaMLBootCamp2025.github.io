...
<input type="checkbox" class="module-checkbox" data-module-id="placer-prep"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="placer-install"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="placer-test"> Mark as complete
...
**Navigation:** [← DiffDock-PP](8-diffdock-pp.qmd) | [Monday Overview](index.qmd) | [Next: BindCraft →](10-bindcraft.qmd)
