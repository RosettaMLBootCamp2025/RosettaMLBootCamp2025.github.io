...
**Related Tools**: For backbone design, see [RFdiffusion2](4-rfdiffusion2.qmd). For sequence design, see [LigandMPNN](3-ligandmpnn.qmd). For structure prediction, see [LocalColabFold](2-localcolabfold.qmd).

<!-- course-tool-pin: bindcraft -->

::: {.callout-note}
## Recorded course pin
The commands below use BindCraft commit `efb5bfeb8b4b1a5944256f979c34e0c8e6a82d9d` (reviewed 2026-08-30). A campaign can take days, so save a successful pilot trajectory and environment record before scaling. See [Reproducible Setup & Compute Fallbacks](reproducibility.qmd).
:::
...
git checkout --detach efb5bfeb8b4b1a5944256f979c34e0c8e6a82d9d
