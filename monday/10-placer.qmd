...
**Related Tools**: For protein-protein docking, see [DiffDock-PP](9-diffdock-pp.qmd). For structure prediction of complexes, see [Chai-1](7-chai1.qmd) or [Boltz-2](8-boltz2.qmd).

<!-- course-tool-pin: placer -->

::: {.callout-note}
## Recorded course pin
The commands below use PLACER commit `7dc5563300e7143582d85636bdd413d4c7688e9a` (reviewed 2026-08-30). For validation status, environment recording, and the equivalent ensemble-analysis artifact, see [Reproducible Setup & Compute Fallbacks](reproducibility.qmd).
:::
...
cd PLACER
git checkout --detach 7dc5563300e7143582d85636bdd413d4c7688e9a
