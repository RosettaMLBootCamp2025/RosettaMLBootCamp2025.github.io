...
|---|---|---|---|
| Structure prediction | Generate the prediction locally or through an approved service | [Download the GFP prediction and confidence dataset](../files/gfp-analysis.zip) | Annotated pLDDT/PAE interpretation and a method-selection memo |
| Sequence design | Run LigandMPNN on a selected backbone | [Use the extracted published binder sequences](../files/binder-analysis.zip) and document missing design lineage | Candidate table and selection rationale |
...
| Capstone | Produce a new end-to-end campaign | [Use the seven-stage published binder workbook](../analysis-lab.qmd#binder-evidence), clearly labeled as re-analysis | The same rubric-scored portfolio; no claim of a novel generated binder |
