...
- Install and confirm each of the core structure prediction tools (LocalColabFold, ESMFold, Chai-1, Boltz-2) on your cluster.
- Install and confirm the core design and docking tools (LigandMPNN, RFdiffusion2, DiffDock-PP, PLACER, BindCraft).
...
<div class="lesson-visual">
  ...
  <p class="lesson-visual-caption">Use this path as the mental model for Monday: prepare on a login node, request GPU resources through the scheduler, then confirm the tool works on the GPU node before moving on.</p>
</div>
