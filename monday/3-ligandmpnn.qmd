...
<div class="workshop-companion">
  <div class="wc-title">🎥 Live workshop recording — Inverse folding using ProteinMPNN</div>
  <div class="wc-video">
    <iframe src="https://www.youtube-nocookie.com/embed/o8JWPjSH1Ig"
      title="Inverse folding using ProteinMPNN"
...
**Related Tools**: Use with [RFdiffusion2](4-rfdiffusion2.qmd) for backbone design, or [BindCraft](11-bindcraft.qmd) for complete binder design pipelines.

<!-- course-tool-pin: ligandmpnn -->

::: {.callout-note}
## Recorded course pin
The commands below use LigandMPNN commit `26ec57ac976ade5379920dbd43c7f97a91cf82de` (reviewed 2026-08-30). For validation status, environment-recording commands, and the equivalent no-compute artifact, see [Reproducible Setup & Compute Fallbacks](reproducibility.qmd).
:::
...
cd LigandMPNN
git checkout --detach 26ec57ac976ade5379920dbd43c7f97a91cf82de
git submodule update --init --recursive
```

2. Download the model parameters:
*Note: This step requires internet access. If your compute node doesn't have internet, run this on a login node.*
```bash
