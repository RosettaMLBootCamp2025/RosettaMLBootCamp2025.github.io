...
**Related Tools**: Use with [LigandMPNN](3-ligandmpnn.qmd) for sequence design after backbone generation. For the earlier version without atomic control, see [RFdiffusion All Atom](13-rfdiffusion-aa.qmd) (Optional).

<!-- course-tool-pin: rfdiffusion2 -->

::: {.callout-note}
## Recorded course pin
The commands below use RFdiffusion2 commit `d365cbf4db3958814a9f8e4f6f94fa309dfebc2b` (reviewed 2026-08-30). For validation status, a preflight command, and the analysis-only pathway when Apptainer or a compatible GPU is unavailable, see [Reproducible Setup & Compute Fallbacks](reproducibility.qmd).
:::
...
[Mark as complete]{.task module-id="rfdiffusion2-prep"}
...
[Mark as complete]{.task module-id="rfdiffusion2-install"}

1. Clone the repository:
```bash
git clone https://github.com/RosettaCommons/RFdiffusion2.git
cd RFdiffusion2
git checkout --detach d365cbf4db3958814a9f8e4f6f94fa309dfebc2b
...
[Mark as complete]{.task module-id="rfdiffusion2-test"}
