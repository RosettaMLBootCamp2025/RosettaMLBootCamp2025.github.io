...
<!-- course-tool-pin: rfdiffusion-aa -->

::: {.callout-note}
## Recorded course pin
The commands below use RFdiffusion All Atom commit `f913a19e16f30858ce7a724fe028475b1871319c` (reviewed 2026-08-30). The container and weights remain external downloads. See [Reproducible Setup & Compute Fallbacks](reproducibility.qmd) for the verification and analysis-only routes.
:::
...
git checkout --detach f913a19e16f30858ce7a724fe028475b1871319c
