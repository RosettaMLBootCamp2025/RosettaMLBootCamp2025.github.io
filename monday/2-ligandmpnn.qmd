...
<input type="checkbox" class="module-checkbox" data-module-id="ligandmpnn-prep"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="ligandmpnn-install"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="ligandmpnn-test"> Mark as complete
...
**Navigation:** [← LocalColabFold](1-localcolabfold.qmd) | [Monday Overview](index.qmd) | [Next: RFdiffusion2 →](3-rfdiffusion2.qmd)
