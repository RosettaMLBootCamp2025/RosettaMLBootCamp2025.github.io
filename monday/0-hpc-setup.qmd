...
<input type="checkbox" class="module-checkbox" data-module-id="hpc-setup-check"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="hpc-setup-conda"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="hpc-setup-containers"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="hpc-setup-slurm"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="hpc-setup-env"> Mark as complete
...
<input type="checkbox" class="module-checkbox" data-module-id="hpc-setup-verify"> Mark as complete
...
**Navigation:** [Monday Overview](index.qmd) | [Next: LocalColabFold →](1-localcolabfold.qmd)
