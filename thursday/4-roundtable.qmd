---
title: "4. Reflection & Capstone Introduction"
---
...
<div class="workshop-companion">
  <div class="wc-title">🎥 Live workshop recording — Protein design roundtable discussion</div>
  <div class="wc-video">
    <iframe src="https://www.youtube-nocookie.com/embed/9pQeQKXhS70"
      title="Protein design roundtable discussion"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      allowfullscreen loading="lazy"></iframe>
  </div>
  <details>
    <summary>📊 View slide deck</summary>
    <iframe src="https://docs.google.com/presentation/d/1q7JIBgvSpYX4gPsRdyW8XZlx0jBR_G7Y/embed?start=false&loop=false&delayms=3000"
      allowfullscreen loading="lazy"></iframe>
  </details>
</div>
```
...
<summary>Compare your workflow sketch with an expert response</summary>

A defensible binder-design workflow begins by defining the biological mission and target interface, then preparing and inspecting a specific target structure. Backbone generation explores geometry; sequence design asks which amino acids can stabilize each retained backbone; complex prediction tests fold and interface consistency; structural and energetic checks remove obvious failures; and the evidence is logged before iteration. Prediction appears both early (to understand uncertain target regions) and late (to validate designed monomers and complexes), but no confidence score substitutes for experimental binding data.
...
- [OpenFold Issues](https://github.com/aqlaboratory/openfold/issues)
