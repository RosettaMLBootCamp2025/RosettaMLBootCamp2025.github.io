...
**Decision:** Pose A has a slightly better docking score than Pose B. Pose A contains a severe steric clash and misses the known binding-site residues; Pose B recovers the native interaction pattern. Which pose should advance, and what would you do next?

<details class="model-answer">
<summary>Compare your reasoning with an expert response</summary>

Pose B is the more defensible candidate. Docking scores are approximate ranking functions, not permission to ignore impossible geometry or prior structural evidence. Inspect both poses, confirm protonation and target preparation, minimize or rescore plausible poses, and use an independent method or experimental evidence before making an affinity claim.
