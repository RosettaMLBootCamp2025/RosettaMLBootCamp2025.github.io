...
<div class="lesson-visual">
  <img src="../images/course-dashboard/cpu-gpu-benchmark.png" alt="Timing chart comparing Python loops, vectorized CPU operations, and vectorized GPU operations across input sizes.">
  <p class="lesson-visual-caption">The practical lesson is not simply "GPU is faster." Vectorization usually matters first, and the GPU wins once the workload is large enough to justify transfer and startup overhead.</p>
</div>
...
2. If every GPU time shows `N/A`, what hardware check should you perform, and how can you still complete the analysis honestly?
