...
<div class="workshop-companion">
  <div class="wc-title">🎥 Live workshop recording — Tools intro: PyMOL & VS Code</div>
  <div class="wc-video">
    <iframe src="https://www.youtube-nocookie.com/embed/MlzFudaWylc"
      title="Tools intro: PyMOL & VS Code"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      allowfullscreen loading="lazy"></iframe>
  </div>
  <details>
    <summary>📊 View slide deck</summary>
    <iframe src="https://docs.google.com/presentation/d/18z-44xvzmgudaZLI-MRByvY3qHvsPVK5/embed?start=false&loop=false&delayms=3000"
      allowfullscreen loading="lazy"></iframe>
  </details>
</div>
```
...
- **Tutorial PDF**: [PyRosetta Workshop PyMOL Tutorial](files/PyMOL.pdf)
:::
